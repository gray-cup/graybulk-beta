export default function UPILogo({ className }: { className?: string }) {
  return (
    <svg
      ...
      <g id="layer1">
        <g transform="matrix(0.35277777,0,0,-0.35277777,-10.926321,61.158633)">
          <g clipPath="url(#clipPath28)">
            ...
            <g transform="translate(67.2119,43.3633)">
              <path d="M 0,0 4.238,17.704 H 7.042 L 2.805,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(74.0488,43.3633)">
              <path d="m 0,0 4.238,17.704 h 9.63 L 13.283,15.262 H 6.458 L 5.401,10.848 h 6.825 L 11.622,8.321 H 4.796 L 2.805,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(86.7686,43.3633)">
              <path d="M 0,0 4.238,17.704 H 7.042 L 2.805,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(93.6055,43.3633)">
              <path d="m 0,0 4.238,17.704 h 9.63 L 13.283,15.262 H 6.458 L 5.395,10.824 H 12.22 L 11.616,8.296 H 4.791 l -1.37,-5.72 h 6.825 L 9.63,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(109.8818,45.9639)">
            ...
            <g transform="translate(136.8799,53.666)">
            ...
            <g transform="translate(148.4458,50.3164)">
            ...
            <g transform="translate(161.5161,43.3633)">
            ...
            <g transform="translate(188.2803,52.1074)">
            ...
            <g transform="translate(192.9419,43.3633)">
              <path d="m 0,0 4.239,17.704 h 9.63 L 13.284,15.262 H 6.458 L 5.396,10.824 h 6.825 L 11.617,8.296 H 4.791 L 3.422,2.576 h 6.825 L 9.629,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(205.791,43.3633)">
            ...
            <g transform="translate(234.4102,58.625)">
              <path d="M 0,0 -3.653,-15.262 H -6.458 L -2.806,0 h -4.585 l 0.585,2.442 H 5.146 L 4.562,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(237.3213,46.9072)">
            ...
            <g transform="translate(258.0459,43.3633)">
              <path d="M 0,0 4.238,17.704 H 7.043 L 2.805,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(264.8828,43.3633)">
            ...
            <g transform="translate(293.502,58.625)">
              <path d="M 0,0 -3.654,-15.262 H -6.458 L -2.806,0 h -4.585 l 0.585,2.442 H 5.146 L 4.562,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(296.5557,43.3633)">
              <path d="m 0,0 4.238,17.704 h 9.63 L 13.284,15.262 H 6.459 L 5.396,10.824 h 6.825 L 11.616,8.296 H 4.791 L 3.422,2.576 h 6.825 L 9.63,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(314.6416,53.5225)">
            ...
            <g transform="translate(322.9258,43.3633)">
              <path d="m 0,0 4.238,17.704 h 9.63 L 13.284,15.262 H 6.458 L 5.401,10.848 h 6.826 L 11.622,8.321 H 4.797 L 2.805,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(340.0449,50.3164)">
            ...
            <g transform="translate(367.3555,56.7627)">
            ...
            <g transform="translate(367.627,43.3633)">
              <path d="m 0,0 4.238,17.704 h 9.63 L 13.283,15.262 H 6.459 L 5.396,10.824 h 6.825 L 11.616,8.296 H 4.791 L 3.422,2.576 h 6.825 L 9.63,0 Z" style={{fill:"#696a6a",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(316.4629,76.4951)">
              <path d="M 0,0 H -19.283 L 7.535,96.855 h 19.284 z" style={{fill:"#66686c",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(306.4521,170.2881)">
              <path d="m 0,0 c -1.337,1.843 -3.399,2.773 -6.2,2.773 h -106.036 l -5.252,-18.97 h 19.294 v 0.011 h 77.169 l -5.614,-20.272 h -77.171 l 0.007,0.042 h -19.286 l -16.007,-57.787 h 19.296 l 10.742,38.786 h 86.746 c 2.709,0 5.259,0.924 7.657,2.772 2.393,1.85 3.968,4.131 4.723,6.855 L 0.809,-6.996 C 1.593,-4.181 1.322,-1.845 0,0" style={{fill:"#66686c",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(156.1196,82.541)">
              <path d="m 0,0 c -1.065,-3.835 -4.557,-6.488 -8.538,-6.488 h -99.491 c -2.711,0 -4.726,0.924 -6.051,2.77 -1.324,1.848 -1.608,4.134 -0.851,6.857 l 24.276,87.387 h 19.301 l -21.683,-78.05 h 77.206 l 21.683,78.05 h 19.297 z" style={{fill:"#66686c",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(376.5859,173.1689)">
              <path d="m 0,0 24.414,-48.553 -51.322,-48.54 z" style={{fill:"#27803b",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
            <g transform="translate(359.4717,173.1689)">
              <path d="m 0,0 24.396,-48.553 -51.343,-48.54 z" style={{fill:"#e9661c",fillOpacity:1,fillRule:"nonzero",stroke:"none"}} />
            </g>
          </g>
        </g>
      </g>
